...
<div id="contents" style="height:600px; background:white; border:1px solid black"><br/><br/><br/><br/>
	<div align="center">
		<form class="form_style" name="memberForm" action="${root}/member/register.do" 
			...
			<div class="line">
				<label  class="title" style="color:white; background:#37415A">비밀번호</label>
				<span class="content" style="color:white; background:#37415A">
			...
			<div class="line">
				<label class="title" style="color:white; background:#37415A">비밀번호확인</label>
				<span class="content" style="color:white; background:#37415A">
			...
			<div class="line">
				<label class="title" style="color:white; background:#37415A">이름</label>
				<span class="content" style="color:white; background:#37415A">
			...
			<div class="line">
				<label class="title" style="color:white; background:#37415A">우편번호</label>
				<span class="content" style="color:white; background:#37415A">
			...
			<div class="line">
				<label class="title" style="color:white; background:#37415A">주소</label>
				<span class="content" style="color:white; background:#37415A" >
			...
			<div class="line">
				<label class="title" style="color:white; background:#37415A">상세주소</label>
				<span class="content" style="color:white; background:#37415A">
			...
			<div class="line">
				<label class="title" style="color:white; background:#37415A">전화번호</label>
				<span class="content" style="color:white; background:#37415A">
			...
			<div class="line" align="center" >
				<label class="title" style="color:black; background:yellow">선택</label>
				<span class="content" style="color:black; background:yellow">
					<font size="1"><b>--------선택사항--------</b></font>
				</span>
			</div>
			
			<div class="line">
				<label class="title" style="color:black; background:yellow">관심분야</label>
				<span class="content" style="color:black; background:yellow">
			...
			<div class="line">
				<label class="title" style="color:black; background:yellow">생년월일</label>
				<span class="content" style="color:black; background:yellow">
			...
			<div class="line">
				<label class="title" style="color:black; background:yellow">이메일</label>
				<span class="content" style="color:black; background:yellow">
					<input type="text" name="member_email" size="25" />
				</span>
			</div>
			
			<div class="line" style="width:591px; border-width:2px; text-align:center; color:white; background:#37415A">
				<input type="submit" class="btn btn-primary btn-xs" value="가입" />
