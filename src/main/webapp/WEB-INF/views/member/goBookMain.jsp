   ...
   <div id="best_bg">
      <ul>
		<c:forEach var="bestSeller" items="${bestSeller}">
			<li>
				<img src="http://localhost:8181/gobook/images/bookImg/${bestSeller.book_cover_file_name}" style="cursor: pointer;" onclick="javascript:userBookRead('${root}', '${bestSeller.book_num}')" width=120px; height="100px;"/>
				<span><strong>
				<c:choose>
   ...
   <div id="new_bg">
      <ul>
		<c:forEach var="newBook" items="${newBook}">
			<li>
				<img  style="cursor: pointer;" src="http://localhost:8181/gobook/images/bookImg/${newBook.book_cover_file_name}" alt="" onclick="javascript:userBookRead('${root}', '${newBook.book_num}')" width=120px; height="100px;"/>
				<span><strong>
				<c:choose>
