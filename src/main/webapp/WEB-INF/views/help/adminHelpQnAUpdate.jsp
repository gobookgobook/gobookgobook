...
<body>
	<div id="contents" style="height:70%; background:white; border:0px solid black;position: static">
		<div id="wrap">
			...
			<div align="center"><b style="font-size:18px">Q&A 수정</b></div>
			...
			<div align="center" class="container" style="width:960px;height:460px;padding:0px;border:0px solid black;margin-left:40px">
				<form style="margin-left:130px" action="${root}/help/adminHelpQnAUpdate.do" method="post" onsubmit="return adminHelpQnAWrite(this)">
					...
					<div>
						...
						<input class="content" type="text" size="50" name="helpqna_subject" style="width:610px;font-size:14px;height:40px" value="${helpQnADto.helpqna_subject}"/>
					</div><br/><br/>
					...
					<div style="height: 67px">
						...
						<textarea class="content" rows="14" cols="64" name="helpqna_content" style="height:288px;width:610px;font-size:14px;border-bottom:2px solid #DDDDDD; resize:none">${helpQnADto.helpqna_content}</textarea>
					</div>

					<div style="margin-top:250px">
						<input type="submit" class="btn btn-success btn-sm" value="Q&A 수정"  style="margin-left:-50px"/>
					</div>
				</form>
			</div>
		</div>
