	...
	<c:if test="${id=='admin'}">
		...
		<div align="left" style="float: left;margin: 0 0 0 50px;width: 80%;">
			...
			<c:if test="${count==0}">
				...
				<div align="center"><span>품절된 도서가 없습니다.</span></div>
			</c:if>
							...
							<c:forEach var="book" items="${bookSoldOutList}">
								<tr class="success">
									...
									<td style="text-align:left">
										<a href="${root}/bookManage/bookRead.do?book_num=${book.book_num}&pageNumber=${currentPage}&pageInfo=bookSOL"  style="margin-left: 20px;">
											<c:choose>
